...
void main() async{
  ...
  testWidgets('payment bottom sheet test', (WidgetTester tester) async{
    PaymentBottomSheet mainWidget = getIt.get<PaymentBottomSheet>();
    var app = MaterialApp(
    ...
    expect(find.byType(PaymentBottomSheet), findsOneWidget);
  });
}