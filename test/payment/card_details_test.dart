...
void main() async{
  setUpAll(() async{
    ...
    GetIt.I.registerSingleton<CardDetails>(CardDetails());
  });
  testWidgets('card details test', (WidgetTester tester) async{
    /*//TODOFIXAA
    when(()=> getCardIcon(any())).thenReturn(Text(''));

    var mainWidget = getIt.get<CardDetails>();
    var app = MaterialApp(
    ...
    expect(find.byType(CardDetails), findsOneWidget);
    */
  });
}