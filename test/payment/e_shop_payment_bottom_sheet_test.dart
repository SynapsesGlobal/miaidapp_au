...
void main() async{
  ...
  testWidgets('eshop payment bottom sheet test', (WidgetTester tester) async{
    var mainWidget = getIt.get<EShopPaymentBottomSheet>();
    var app = MaterialApp(
    ...
    expect(find.byType(EShopPaymentBottomSheet), findsOneWidget);
  });
}