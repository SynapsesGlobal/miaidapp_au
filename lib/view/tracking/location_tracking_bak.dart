  ...
  Future<void> _getPositionSetting() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _open = responseData['position_tracking'] ? true : false;
          _controller.text = responseData['position_tracking'] ? responseData['tracking_email'] : '';
          _frequency = responseData['position_tracking'] ? int.parse(responseData['tracking_frequency']) : 1;
        });
      } else {
        await EasyLoading.dismiss();
