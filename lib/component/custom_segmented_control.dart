...
class MiAidCupertinoSegmentedControl<T extends Object> extends StatefulWidget {
  ...
  @override
  State<MiAidCupertinoSegmentedControl<T>> createState() => _SegmentedControlState<T>();
}

class _SegmentedControlState<T extends Object> extends State<MiAidCupertinoSegmentedControl<T>>
